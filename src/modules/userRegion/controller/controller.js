...
export const getAll = async (req, res) => {
  try {
    ...
    const result = await service.getAll(page, perPage, search, user_id, region_id);
...
export const create = async (req, res) => {
  try {
    ...
    const newData = await service.create(user_id, region_id);
...
export const remove = async (req, res) => {
  try {
    const { user_id, region_id } = req.params;
    await service.remove(user_id, region_id);
